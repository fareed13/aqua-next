...
export function CarouselDefault({ headline, content, media }: SectionProps) {
  ...
  const services = useOrgStore(s => s.location)
  const [currentSlide, setCurrentSlide] = useState(0)

  // Build slides from media or services
  ...
  return (
    <div className="home-slider relative">
      ...
      <svg
        id="top-shape"
        data-name="Layer 1"
        viewBox="0 0 493 153.07"
        className="w-[31%] -ml-[100px] absolute z-20"
        style={{ marginTop: '-54px', transform: 'rotate(2deg)' }}
      >
        <defs />
        <polygon
          style={{ fill: accentColor }}
          points="45.67 146.83 6.06 153.07 0 0 493 54.83 45.67 146.83"
        />
        <path
          style={{ fill: accentDark }}
          d="M1217.5,560.5l33.17,30.83-175.39-19.5L1217.5,560.5Z"
          transform="translate(-757.67 -536.5)"
        />
      </svg>
    </div>
  )
